...
IF NOT DEFINED IFCOS_INSTALL_QT6 set IFCOS_INSTALL_QT6=FALSE
...
:ccache
	...
	IF NOT DEFINED FORCE_DEPS_REBUILD ( IF EXIST "%DEPENDENCY_DIR%" (
...
:proj
	set PROJ_VERSION=9.4.1
	IF NOT DEFINED FORCE_DEPS_REBUILD ( IF EXIST "%INSTALL_DIR%\proj-%PROJ_VERSION%" (
...
:mpir
	IF NOT DEFINED FORCE_DEPS_REBUILD ( IF EXIST "%INSTALL_DIR%\mpir" (
...
:mpfr
	IF NOT DEFINED FORCE_DEPS_REBUILD ( IF EXIST "%INSTALL_DIR%\mpfr" (
...
:OpenCOLLADA
	...
	IF NOT DEFINED FORCE_DEPS_REBUILD call :CheckInstallation
	if %ERRORLEVEL%==200 GOTO %NEXT_DEPENDENCY_LABEL%
...
:cgal
	IF NOT DEFINED FORCE_DEPS_REBUILD ( IF EXIST "%INSTALL_DIR%\cgal" (
...
:manifold
	...
	REM set MANIFOLD_VERSION=3.2.1
	...
	IF NOT DEFINED FORCE_DEPS_REBUILD ( IF EXIST "%DEPENDENCY_INSTALL_DIR%" (
		echo Found existing "%DEPENDENCY_INSTALL_DIR%", skipping
		goto :Eigen
	))
...
:Eigen
	...
	IF NOT DEFINED FORCE_DEPS_REBUILD ( IF EXIST "%INSTALL_DIR%\%DEPENDENCY_NAME%" (
